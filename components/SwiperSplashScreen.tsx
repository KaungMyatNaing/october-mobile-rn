...
const SwiperSplashScreen = () => {
  ...
  return (
    <Swiper style={styles.wrapper} showsButtons loop={false} dot={<View style={{ backgroundColor: 'pink', padding: 5, marginLeft: 5, borderRadius: 10 ,width: '100%', height: 500}}></View>} activeDot={<View style={{ backgroundColor: 'white', padding: 5, marginLeft: 5, borderRadius: 10 }}></View>} >
