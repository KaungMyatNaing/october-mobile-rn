...
const ChossePayment = ({navigation}) => {
    ...
    <>
     <Box width='100%' px={15} py={4}>
         ...
         <HStack justifyContent='flex-start' alignItems='center' space={5}>
             <TouchableOpacity onPress={() => navigation.goBack()}><AntIcon size={20} name='left' /></TouchableOpacity>
             <Text fontSize='md' display='flex' style={{ fontFamily: 'GothamPro-Bold' }}>Your Checkout Information</Text>
      ...
      <Box width='100%' h='100%' justifyContent='center' alignItems='center' flex={1} paddingBottom='250' paddingTop='15'> 
        ...
        <ChossePayment />
          {/*<PaymentMethod />*/}
          <Button onPress={()=>navigation.navigate("OrderDetailScreen")}
            style={{width:'90%', position:'absolute',bottom: 25}}
              backgroundColor={'#FF6195'}
              rounded={'xl'}>
              Check Out Now
            </Button>
